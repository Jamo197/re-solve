...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('property_name', models.CharField(choices=[('Zugfestigkeit', 'Tensile Strength'), ('Dehngrenze', 'Breaking Strength'), ('Dichte', 'Density'), ('Bruchdehnung', 'Fracture Strain'), ('Härte', 'Hardness')], max_length=25)),
                ('value', models.FloatField(default=0)),
                ('unit', models.CharField(max_length=60)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
